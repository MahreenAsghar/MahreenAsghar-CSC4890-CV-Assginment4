...
gen = idg.flow_from_directory("./objimg",target_size=(200,200))
...
o1 = Conv2D(15, 3, activation="relu")(inlayer)
ap1 = MaxPooling2D(2)(o1)
o2 = Conv2D(30, 3, activation="relu")(ap1)
ap2 = MaxPooling2D(2)(o2)
o3 = Conv2D(60, 3, activation="relu")(ap2)
ap3 = MaxPooling2D(2)(o3)
o4 = Conv2D(120, 3, activation="relu")(ap3)
ap4 = MaxPooling2D(2)(o4)
flat = Flatten()(ap4)
d1 = Dense(900, activation="relu")(flat)
d2 = Dense(500, activation="relu")(d1)
d3 = Dense(300, activation="relu")(d2)
d4 = Dense(150, activation="relu")(d3)
drop1 = Dropout(.2)(d4)
d5 = Dense(50, activation="relu")(drop1)
...
foundImg = cv2.imread("./objimg/found/capture_isp_1.png")
